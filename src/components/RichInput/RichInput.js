...
const RichInputWrapper = styled('div')({
  '& .rich-input': {
    ...
    "& .rich-input__input-label": { lineHeight: "150%", textAlign: "left" },
    '& .rich-input__input-tooltip-icon': {
      marginBottom: "3px",
      color: "#898989",
      fontSize: "18px",
      ".": { backgroundColor: "#000" },
    ...
    <ThemeProvider theme={theme}>
      <RichInputWrapper>
        ...
        >
          <Box
            component={"div"}
            className="rich-input__input-wrapper"
          >
            <Typography
              variant="p"
              className="rich-input__input-label"
            >
              {label}
            </Typography>
            {tooltip ? (
              <Tooltip title={tooltip} placement="top" arrow>
                <Icon
                  className="rich-input__input-tooltip-icon"
                >
                  error
                </Icon>
              </Tooltip>
