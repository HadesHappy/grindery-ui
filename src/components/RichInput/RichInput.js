...
const RichInput = ({
  ...
  const renderDropdown = () => {
    ...
    return (<Box className="rich-input__dropdown">
      {(tabs.length > 1 ) && (
      ...
      {hasAddressBook && (tabs.length > 1 ? tab === tabs.indexOf('Address Book') : true) && (
        ...
        <Box className="rich-input__dropdown-options-wrapper">
          ...
          {hasAddressBook && tab === tabs.indexOf('Address Book') && (
            ...
            {addressBookView === 'list' && (
              <>
            {addressBook.length > 0 && tab === tabs.indexOf('Address Book') && renderSearch()}
  ...
  const renderOption = (option) => (
    <Box
      component="div"
      key={option.value}
      className={`rich-input__dropdown-option ${option.isAddressBook ? 'has-actions' : ''}`}
    >
      <Box
        component="div"
      ...
      >
        ...
        <span><strong>{option.label}</strong> {option.reference}</span>
      </Box>
...
const BackIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M11.9493 1.00338C11.949 1.26851 11.8435 1.52269 11.6559 1.71005L6.54125 6.82472C6.38644 6.97949 6.26363 7.16324 6.17985 7.36548C6.09606 7.56771 6.05294 7.78448 6.05294 8.00338C6.05294 8.22229 6.09606 8.43905 6.17985 8.64129C6.26363 8.84353 6.38644 9.02728 6.54125 9.18205L11.6493 14.29C11.8314 14.4787 11.9322 14.7313 11.9299 14.9935C11.9276 15.2556 11.8225 15.5065 11.6371 15.6919C11.4517 15.8773 11.2008 15.9824 10.9387 15.9847C10.6765 15.987 10.4239 15.8862 10.2353 15.7041L5.12725 10.6C4.44043 9.91188 4.05469 8.97932 4.05469 8.00705C4.05469 7.03478 4.44043 6.10223 5.12725 5.41405L10.2419 0.29605C10.3818 0.156106 10.56 0.0607924 10.754 0.0221697C10.9481 -0.0164531 11.1492 0.00335101 11.332 0.079076C11.5148 0.154801 11.671 0.283043 11.7809 0.447576C11.8907 0.612108 11.9493 0.805536 11.9493 1.00338Z" fill="#8C30F5"/>
  </svg>
