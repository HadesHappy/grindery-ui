  ...
  return (
    <div className="App">
      <PaperBox>
        ...
        <SelectInput options={options} type={"default"} value={value} label={'Connect with...'} required={true}  texthelper="You must have column headers" onChange={handleChange} placeholder={"Choose sheet..."} ></SelectInput>
        <SelectInput options={options} type={"default"} value={value} label={'Connect with...'} required={true}  texthelper="You must have column headers"  onChange={handleChange} placeholder={"Choose sheet..."} ></SelectInput>
        <SelectInput options={options} type={"searchLabel"} value={value} variant={"full"}  texthelper="You must have column headers" onChange={handleChange} label={'Connect with...'}   placeholder={"0x"}></SelectInput>
        <SelectInput options={options} type={"searchLabel"} value={value} variant={"default"} texthelper="You must have column headers"  onChange={handleChange} label={'Connect with...'} placeholder={"0x"}></SelectInput>
